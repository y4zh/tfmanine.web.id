            ...
            directions: [
                {
                    ...
                    stops: [
                        ...
                        { name: "Jln. Teluk Mandar 1", transfers: ["JAK 02", "JAK 85"], isActive: true },
                        ...
                        { name: "Jln. Serdang", transfers: ["11Q", "JAK 39", "JAK 42"], isActive: true },
                        ...
                        { name: "Jln. I Gusti Ngurah Rai 1", transfers: [] },
                        { name: "Kampung Jembatan Ngurah Rai", transfers: [] },
                        { name: "Perumnas Klender 2", transfers: ["11Q", "JAK 39"] },
                        { name: "Sekolah PGRI Penggilingan", transfers: [] },
                        { name: "Penggilingan 1", transfers: ["11B", "11Q", "11R", "JAK 100"] },
                        { name: "Pengadilan Negeri Jaktim 1", transfers: [] },
                        { name: "Jln. Dr. Sumarno", transfers: [] },
                        { name: "Walikota Jakarta Timur 1", transfers: ["11B", "11Q", "JAK 100"] }
                    ]
                },
                {
                    ...
                    stops: [
                        { name: "Walikota Jakarta Timur 1", transfers: ["11B", "11Q", "JAK 100"] },
                        { name: "Kodim 0505 1", transfers: [] },
                        { name: "Kodim 0505 2", transfers: [] },
                        { name: "Walikota Jakarta Timur 2", transfers: ["11B", "11Q", "JAK 100"] },
                        { name: "Pengadilan Negeri Jaktim 2", transfers: [] },
                        { name: "Penggilingan 2", transfers: ["11B", "11Q", "11R", "JAK 100"] },
                        ...
                        { name: "Carrefour Buaran", transfers: [] },
                        { name: "SMKN 48", transfers: ["11Q", "JAK 39"] },
                        { name: "Budhaya Santo Agustinus", transfers: ["11Q", "JAK 99"] },
                        { name: "Kasi Dikdas 2", transfers: [] },
                        ...
                        { name: "Jln. Kel. Raya", transfers: ["11Q", "JAK 02", "JAK 26", "JAK 42"], isActive: true },
                        { name: "Masjid Jami Al Barkah 2", transfers: ["11Q", "JAK 02", "JAK 26", "JAK 42"] },
                        { name: "Sbr. SMPN 195", transfers: ["JAK 02", "JAK 26"] },
                        { name: "RS Duren Sawit 2", transfers: ["JAK 26"] },
                        { name: "Gereja Santa Anna 2", transfers: ["JAK 02", "JAK 85"] },
                        { name: "Jln. Teluk Mandar 2", transfers: ["JAK 02", "JAK 85"], isActive: true, label: "Terdekat" },
                        { name: "Rusun Pondok Bambu", transfers: ["JAK 85"], isActive: true }
                    ]
                }
            ]
        },
