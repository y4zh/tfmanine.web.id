            ...
            directions: [
                {
                    ...
                    stops: [
                        ...
                        { name: "Stasiun Jatinegara", transfers: ["11M", "B25", "C"], icons: ["icon-train.svg"] },
                        ...
                        { name: "Simpang Buaran", transfers: ["11M", "C"], icons: ["icon-train.svg"], isActive: true, label: "Terdekat" },
            ...
            directions: [
                ...
                },
                {
                    ...
                    stops: [
                        ...
                        { name: "Flyover Radin Inten 2", transfers: ["11P", "JAK 39", "C"] },
            ...
            directions: [
                {
                    ...
                    stops: [
                        ...
                        { name: "Tanah Abang", transfers: ["R"], trainConnections: ["R"] },
                        { name: "Duri", transfers: ["A", "T"], trainConnections: ["A", "T"] },
                        { name: "Angke", transfers: [] },
                        { name: "Kampung Bandan", transfers: ["TP"], trainConnections: ["TP"] },
            ...
            directions: [
                {
                    name: "Full Route",
                    stops: [
                        { name: "Dukuh Atas", transfers: ["CB", "BK"], icons: ["icon-train.svg", "MRT.svg"], trainConnections: ["C", "MRT", "A"], halteInfo: { type: "integrasi", stops: [{ halte: "Galunggung", routes: ["4", "6"] }, { halte: "Dukuh Atas", routes: ["1", "1B", "6A", "6B"] }] }, stationIntegration: { station: "Sudirman", trainLines: ["C"] } },
                        ...
                        { name: "Cikoko", transfers: ["B"], icons: ["icon-train.svg"], trainConnections: ["B"], halteInfo: { type: "integrasi", halte: ["Cikoko"], routes: ["4K", "7D", "9", "9A", "9C"] } },
...
window.routeColors = {
    ...
    // KRL Train Lines
    "A": "#262262",      // Lin Bandara Soetta
    "B": "#ec2329",      // Lin Bogor/Nambo
    "C": "#26baed",      // Lin Cikarang
    "T": "#c25f28",      // Lin Tangerang
    "R": "#99ca3e",      // Lin Rangkasbitung
    "TP": "#ef509a",     // Lin Tanjung Priok
    "CB": "#21409a",     // Lin Cibubur
    "BK": "#006838",     // Lin Bekasi (LRT)
